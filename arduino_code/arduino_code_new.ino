...
const char mySSID[] = "falldetection";
const char myPSK[] = "cs144rproject";
...
void serverDemo()
{
  ...
  {
    myservo.write(pos);
    String distance = lidarGetRange();
    values += distance;
    values += "\n";
    uS = sonar.ping();
    String sonar_str = (String)(uS / US_ROUNDTRIP_CM);
    values += sonar_str;
    values += "\n";
    delay(15);
  }
...
void serialPrintRange(int pos, String distance)
{
